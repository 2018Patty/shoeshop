...
<body>
    ...
    <div class="container">
        ...
        <h1 class="headingCenter">Product Catalog</h1>
                                ...
                                <div class='card shadow-sm'>
                                    ...
                                    <div class='card-body'>
                                        ...
                                        <div class='d-flex justify-content-between'>
                                            <h5 class='card-title'>". $rs['ProductName']. "</h5>
                                            <h5 class='card-title price'>". number_format($rs['ProductPrice'],0). " Baht.</h5>
                                        </div>
                                        ...
                                        <div class='d-flex justify-content-between'>
                                            ...
                                            <form method='post' action = 'cart2.php'>
                                                <input type='hidden' name = 'pid' value='". $rs['ProductID']."'>
                                                <input type='submit' class='btn btn-outline-secondary fas fa-shopping-cart' value='&#xf07a'>
            ...
            <ul class="pagination d-flex justify-content-end">
                <?php 
                    if ($n>1){
                        echo 
                        "<li class='page-item'>
                            <a class='page-link' href='productCatalogPagination.php?n=". ($n-1) ."'>Previous</a>
                        </li>";
                    }else{
                        echo 
                        "<li class='page-item'>
                            <a class='page-link' href='productCatalogPagination.php?n=1'>Previous</a>
                        </li>";
                    } 
                    $i=1;
                    while($i<=$numPages){ 
                    echo 
                        "<li class='page-item'>
                            <a class='page-link' href='productCatalogPagination.php?n=".$i."'>". $i. "</a>
                        </li>";  
                        $i++;
                    } 
                    if ($n<$numPages){   
                        echo 
                            "<li class='page-item'>
                                <a class='page-link' href='productCatalogPagination.php?n=".  ($n+1) ."'>Next</a>
                            </li>";
                    }else{
                        echo
                            "<li class='page-item'>
                                <a class='page-link' href='productCatalogPagination.php?n=".$numPages  ."'>Next</a>
                            </li>";
